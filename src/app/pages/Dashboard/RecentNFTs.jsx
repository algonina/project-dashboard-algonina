...
import { recentNFTsData } from '../../../vendor/common/data/dashboardNFT';
import { topCollectionData } from '../../../vendor/common/data/dashboardNFT';
import { popularCreatorsData } from '../../../vendor/common/data/dashboardNFT';

// Import Images
import usFlag from '../../../vendor/assets/images/flags/us.svg';
import russiaFlag from '../../../vendor/assets/images/flags/russia.svg';
import spainFlag from '../../../vendor/assets/images/flags/spain.svg';
import italyFlag from '../../../vendor/assets/images/flags/italy.svg';
import germanyFlag from '../../../vendor/assets/images/flags/germany.svg';
                  ...
                  <tbody>
                    {recentNFTsData.map((item, key) => (
                      <tr key={key}>
                        ...
                        <td>
                          <img src={item.icon} className='avatar-xxs me-2' alt='' />
                          {item.volume}
                        </td>
                        <td>
                          <span
                            className={item.textColor ? 'text-danger mb-0' : 'text-success mb-0'}
                          >
        ...
        <Col xxl={3} lg={6}>
          <Card className='card-height-100'>
            ...
            <CardBody>
              ...
              <div className='mt-1'>
                <p className='mb-1'>
                  <img src={usFlag} alt='' height='15' className='rounded me-2' /> United States{' '}
                  <span className='float-end'>34%</span>
                </p>
                <p className='mb-1'>
                  <img src={russiaFlag} alt='' height='15' className='rounded me-2' /> Russia{' '}
                  <span className='float-end'>27%</span>
                </p>
                <p className='mb-1'>
                  <img src={spainFlag} alt='' height='15' className='rounded me-2' /> Spain{' '}
                  <span className='float-end'>21%</span>
                </p>
                <p className='mb-1'>
                  <img src={italyFlag} alt='' height='15' className='rounded me-2' /> Italy{' '}
                  <span className='float-end'>13%</span>
                </p>
                <p className='mb-0'>
                  <img src={germanyFlag} alt='' height='15' className='rounded me-2' /> Germany{' '}
          ...
          <Card>
            <CardHeader className='d-flex align-items-center'>
              ...
              <Link
                ...
                type='button'
                className='btn btn-soft-primary shadow-none btn-sm flex-shrink-0'
              >
