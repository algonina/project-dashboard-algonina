...
// Import Images
import Bgd from '../../../vendor/assets/images/bg-d.png';
          ...
          <Card className='overflow-hidden'>
            <CardBody className='bg-marketplace d-flex'>
              <div className='flex-grow-1'>
                <h4 className='fs-18 lh-base mb-0'>Selamat datang, Nugroho</h4>
                <p className='mb-0 mt-2 pt-1 text-muted'>Buat mengajarmu menjadi lebih menarik</p>
