...
// actions
import { loginUser, socialLogin, resetLoginFlag } from '../../../vendor/store/actions';
...
const Login = (props) => {
  ...
  const validation = useFormik({
    ...
    onSubmit: (values) => {
      dispatch(actPostDataAuth(values));
    },
  });
  ...
  document.title = 'Algonina - Dashboard';
  return (
    <React.Fragment>
      <ParticlesAuth>
        <div className='auth-page-content'>
          <Container>
            <Row>
              <Col lg={12}>
                <div className='text-center mt-sm-5 mt-0 mb-4 text-white-50'>
                  <div>
                    <Link to='/' className='d-inline-block auth-logo'>
                      <img src={logoLight} alt='' height='60' />
                    </Link>
                  </div>
                  <p className='mt-3 fs-15 fw-medium text-black'>{process.env.REACT_APP_TITLE}</p>
                </div>
              </Col>
            </Row>
                      ...
                      >
                        ...
                        <div className='mt-4'>
                          <Button
                            ...
                            type='submit'
                          >
                            {statusLogin === 'loading' ? 'loading..' : 'Log In'}
                          </Button>
                        </div>
