import React, { createContext, useEffect, useContext, useState, ReactDOM } from 'react';
...
export function ProviderLoading({ children }) {
  ...
  return <IndicatorContext.Provider value={setCount}>{children}</IndicatorContext.Provider>;
}
