  ...
  constructor(props) {
    ...
    const data = [
      ...
      },
      {
        ...
        img: avatar6,
        set1: [{ id: 1, name: 'Jean Wood', designation: 'Developer', img: avatar7 }],
      },
    ];
          ...
          <Card>
            ...
            <CardBody>
              <p className='text-muted'>
                Use <code>nested-list nested-sortable</code> class to list-group class to set a
                nested list with sortable items where images are attached within a list-group-item
                div element.
              </p>
