    ...
    <React.Fragment>
      <div className="d-flex mb-3 me-4">
        <div className="flex-grow-1">
          <h6 className="fs-14 text-uppercase fw-semibold mb-0"> {props.name} <small className={"badge align-bottom ms-1 totaltask-badge bg-" + props.badgeClass}>{props.badge}</small></h6>
        </div>
