          ...
          <Row>
            ...
            <Col xl={6}>
              <Card>
                ...
                <CardBody>
                  <p className='text-muted'>
                    Use <code>table-striped</code> class to add zebra-striping to any table row
                    within the &lt;tbody&gt;.
                  </p>
                  <div className='live-preview'>
                    <div className='table-responsive'>
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className='text-muted'>
                    Use <code>table-hover</code> class to enable a hover state on table rows within
                    a &lt;tbody&gt;.
                  </p>
              ...
              <Card>
                ...
                <CardBody>
                  <p className='text-muted mb-4'>
                    Use <code>table-card</code> class to show card-based table within a
                    &lt;tbody&gt;.
                  </p>
                  <div className='live-preview'>
          ...
          <Row>
            ...
            <Col xl={6}>
              <Card>
                ...
                <CardBody>
                  <p className='text-muted'>
                    Use <code>table-bordered</code> class to show borders on all sides of the table
                    and cells.
                  </p>
                  <div className='live-preview'>
                    <div className='table-responsive'>
          ...
          <Row>
            <Col xl={6}>
              <Card>
                ...
                <CardBody>
                  <p className='text-muted'>
                    Use <code>border-</code> class with color variation class to set table border
                    color.
                  </p>
          ...
          <Row>
            <Col xl='6'>
              <Card>
                ...
                <CardBody>
                  <p className='text-muted'>
                    Use <code>table-sm</code> class to create any table more compact by cutting all
            ...
            <Col xl={6}>
              <Card>
                ...
                <CardBody>
                  <p className='text-muted'>
                    Use <code>table-light</code> or <code>table-dark</code> class to create
          ...
          <Row>
            <Col xl={6}>
              <Card>
                ...
                <CardBody>
                  <p className='text-muted'>
                    Add <code>&lt;tbody&gt;</code> attribute to group footer content in an HTML
                    table.
                  </p>
                  <div className='live-preview'>
                    <div className='table-responsive'>
            ...
            <Col xl={6}>
              <div className='card'>
                ...
                <CardBody>
                  <p className='text-muted'>
                    You can also put the <code>&lt;caption&gt;</code> attribute on the top of the
                    table with <code>caption-top</code> class.
                  </p>
          ...
          <Row>
            <Col xl={6}>
              <Card>
                ...
                <CardBody>
                  <p className='text-muted'>
                    Example of basic table nesting. Border styles, active styles, and table variants
                    are not inherited by nested tables.
                  </p>
                  <div className='live-preview'>
                    <div className='table-responsive'>
                      <Table className='table-nowrap mb-0'>
            ...
            <Col xl={6}>
              <Card>
                ...
                <div className='card-body'>
                  <p className='text-muted'>
                    Use <code>table-</code> class with below-mentioned color variation class within
                    &lt;tr&gt; to set color on table row.
                  </p>
              ...
              <Card>
                ...
                <CardBody>
                  <p className='text-muted'>
                    ...
                    <code>&lt;table&gt;</code> and are aligned to the the top by default. Use the
          ...
          <Row>
            <Col xl={12}>
              <Card>
                ...
                <CardBody>
                  <p className='text-muted'>
                    Use <code>table-responsive</code> class to make any table responsive across all
                    viewports. Responsive tables allow tables to be scrolled horizontally with ease.
                  </p>
                  <div className='live-preview'>
                    <div className='table-responsive'>
                      <Table className='align-middle table-nowrap mb-0'>
