          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className='text-muted'>
                    Use <code>outline</code> atrribute with the below-mentioned variation to create
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className='text-muted'>
                    Use <code>btn-soft-</code> class with the below-mentioned variation to create a
                    button with the soft background.
                  </p>{' '}
                  <div className='live-preview'>
                    <div className='d-flex flex-wrap gap-2'>
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className='text-muted'>
                    Use <code>btn-ghost-</code> class with the below-mentioned variation to create a
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className='text-muted'>
                    Use <code>btn-lg</code> class to create a large size button and{' '}
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className='text-muted'>
                    Use <code>w-xs,w-sm,w-md,w-lg</code> class to make different sized buttons
                    respectively.
                  </p>
                  <div className='live-preview'>
                    <div className='d-flex flex-wrap gap-2'>
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className='text-muted'>
                    Use <code>btn</code> class with different HTML elements. (though some browsers
              ...
              <Card>
                ...
                <CardBody>
                  ...
                  <div className='d-none code-view'>
                    <pre className='language-markup'>
                      <code>
                        &lt;!-- Toggle Button Status --&gt; &lt;button type=&quot;button&quot;
                        className=&quot;btn btn-primary waves-effect waves-light&quot;
                        data-bs-toggle=&quot;button&quot; aria-pressed=&quot;false&quot;&gt; Single
                        toggle &lt;/button&gt;
                      </code>
                    </pre>
                  </div>
          ...
          <Row>
            <Col lg={6}>
              <Card>
                ...
                <CardBody>
                  <p className='text-muted'>
                    Use the <code>btn-group </code> class in the parent class to wrap a series of
                    buttons.
                  </p>
                  <div className='live-preview'>
                    <Row>
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className='text-muted'>
                    Use <code>btn-toolbar</code> class to combine sets of button groups into more
                    complex components.
                  </p>
                  <div className='live-preview'>
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className='text-muted'>
                    Use <code>btn-group-</code> class with the below-mentioned variation to set the
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className='text-muted'>
                    Make a set of buttons appear <code>vertically</code> stacked .Split button
