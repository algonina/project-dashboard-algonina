                                        ...
                                        <div className='accordion-item border-0'>
                                            ...
                                            >
                                              <div className='d-flex'>
                                                ...
                                                <div className='flex-grow-1 ms-3'>
                                                  ...
                                                  <small className='text-muted'>
                                                    We talked about a project on linkedin - 1 week
                                                    Ago
                                                  </small>
                                                </div>
                                              </div>
                                          ...
                                          <UncontrolledCollapse toggler='#collapse8' defaultOpen>
                                            <div className='accordion-body ms-2 ps-5 fst-italic'>
                                              ...
                                              template. The maximum file size for uploads in this
                                              demo :
                                              <Row className='mt-2'>
                                                <Col xxl={6}>
                                          ...
                                          <UncontrolledCollapse toggler='#collapse10' defaultOpen>
                                            <div className='accordion-body ms-2 ps-5'>
                                              <p className='text-muted fst-italic mb-2'>
                                                ...
                                                boostrap 5.1.3 so far). I integrated it into a Rails
                                                6 project. Needs manual integration work of course
                                            ...
                                            >
                                              <div className='d-flex'>
                                                ...
                                                <div className='flex-grow-1 ms-3'>
                                                  <h6 className='fs-14 mb-1'>Megan Elmore</h6>
                                                  <small className='text-muted'>
                                                    Adding a new event with attachments - 1 month
                                                    Ago.
                                                  </small>
                                                </div>
                                              </div>
                        ...
                        <div className='acitivity-timeline'>
                          ...
                          <div className='acitivity-item d-flex'>
                            ...
                            <div className='flex-grow-1 ms-3'>
                              ...
                              <p className='text-muted mb-2'>
                                User <span className='text-secondary'>Erica245</span> submitted a
                                ticket.
                              </p>
