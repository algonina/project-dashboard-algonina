    ...
    () => [
      {
        ...
        Cell: (cellProps) => {
          return (
            <input type='checkbox' className='orderCheckBox' value={cellProps.row.original._id} />
          );
        },
        id: '#',
      },
      ...
      },
      {
        ...
        Cell: (cell) => {
          switch (cell.value) {
            case 'Pending':
              return (
                <span className='badge text-uppercase badge-soft-warning'> {cell.value} </span>
              );
            case 'Cancelled':
              return <span className='badge text-uppercase badge-soft-danger'> {cell.value} </span>;
            case 'Inprogress':
              return (
                <span className='badge text-uppercase badge-soft-secondary'> {cell.value} </span>
              );
            case 'Pickups':
              return <span className='badge text-uppercase badge-soft-info'> {cell.value} </span>;
            case 'Returns':
              return (
                <span className='badge text-uppercase badge-soft-primary'> {cell.value} </span>
              );
            case 'Delivered':
              return (
                <span className='badge text-uppercase badge-soft-success'> {cell.value} </span>
              );
            default:
              return (
                <span className='badge text-uppercase badge-soft-warning'> {cell.value} </span>
